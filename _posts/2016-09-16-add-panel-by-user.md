...
* [Build a dynamic UI that reacts to user input - RStudio](http://shiny.rstudio.com/articles/dynamic-ui.html){:target="_blank"}
* [shiny app will not work if the same "output" is used two times in Ui.R](https://github.com/rstudio/shiny/issues/743){:target="_blank"}
